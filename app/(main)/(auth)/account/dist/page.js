    ...
    return (React.createElement("div", { className: "min-h-screen bg-gray-100" },
        isMobile && (React.createElement("header", { className: "sticky top-0 z-40 bg-white shadow-sm lg:hidden" },
            React.createElement("div", { className: "flex items-center justify-between p-4" },
                ...
                React.createElement("h1", { className: "text-lg font-semibold" }, currentTab === "profile" ? "My Account" : "Setting"),
        ...
        React.createElement("div", { className: "flex" },
            ...
            React.createElement("main", { className: "flex-1 p-4 lg:p-6 " + (isMobile ? 'pt-0' : '') },
                ...
                currentTab === "orders" && (React.createElement("div", { className: "bg-white rounded-xl p-4 lg:p-6 shadow" },
                    React.createElement("h2", { className: "text-xl lg:text-2xl font-semibold mb-6" }, "Setting"),
                    React.createElement("div", { className: "text-center py-12" },
                        React.createElement(lucide_react_1.Settings, { size: 64, className: "text-gray-300 mx-auto mb-4" }),
                        React.createElement("p", { className: "text-gray-600 text-lg mb-2" }, "No developed yet"),
                        React.createElement("p", { className: "text-gray-500 mb-6" }, "Click on change password"),
                        React.createElement("button", { onClick: function () { return router.push("/"); }, className: "bg-black text-white px-6 py-3 rounded-lg hover:bg-gray-800 transition-colors" }, "Change Password"))))))));
}
