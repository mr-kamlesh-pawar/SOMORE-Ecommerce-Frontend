...
var ShopifyCollection_1 = require("@/components/pages/ShopifyCollection/ShopifyCollection");
...
function OrganicSection() {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, appwrite_1.databases.listDocuments(process.env.NEXT_PUBLIC_APPWRITE_DB_ID, process.env.NEXT_PUBLIC_APPWRITE_PRODUCTS_COLLECTION_ID, [
                                ...
                                appwrite_2.Query.equal("homeSection", "organic-powders"),
                    ...
                    case 2:
                        err_1 = _a.sent();
                        console.error("Organic fetch error:", err_1);
                        return [3 /*break*/, 4];
                    case 3:
                        setLoading(false);
                        return [7 /*endfinally*/];
    ...
    return (React.createElement(ShopifyCollection_1["default"], { title: "Organic Powders", products: products.map(function (p) {
            var _a;
            return ({
                id: p.$id,
                title: p.name,
