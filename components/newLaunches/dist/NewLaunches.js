...
function NewLaunches(_a) {
    ...
    return (React.createElement("section", { className: "w-full bg-white py-6 md:py-10" },
        React.createElement("div", { className: "max-w-[1600px] mx-auto px-3 md:px-6" },
            React.createElement(framer_motion_1.motion.h2, { initial: { opacity: 0, y: 20 }, whileInView: { opacity: 1, y: 0 }, transition: { duration: 0.6 }, className: "text-center text-3xl md:text-4xl font-semibold text-black mb-12" }, title),
            React.createElement("div", { className: "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-y-10 gap-x-4" }, homeProducts.map(function (item, index) { return (React.createElement(framer_motion_1.motion.div, { key: item.id, initial: { opacity: 0, y: 20 }, whileInView: { opacity: 1, y: 0 }, transition: { duration: 0.4, delay: index * 0.1 }, viewport: { once: true } },
                React.createElement(link_1["default"], { href: item.link, className: "group text-center block", "aria-label": "View " + item.title },
            ...
            React.createElement(framer_motion_1.motion.div, { className: "flex justify-center mt-10", initial: { opacity: 0, y: 20 }, whileInView: { opacity: 1, y: 0 }, transition: { duration: 0.6, delay: 0.3 } },
